...
export default function NewNumberHabitPage() {
            ...
            <CardHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription>Configure your number-based habit</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="title"
                    placeholder="e.g., Reading, Exercise, Water intake"
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="metric"
                    placeholder="e.g., pages, minutes, glasses, kilometers"
